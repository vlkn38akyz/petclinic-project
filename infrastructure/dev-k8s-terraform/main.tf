...
variable "sec-gr-mutual" {
  default = "petclinic-k8s-mutual-sec-group-2"
}

variable "sec-gr-k8s-master" {
  default = "petclinic-k8s-master-sec-group-2"
}

variable "sec-gr-k8s-worker" {
  default = "petclinic-k8s-worker-sec-group-2"
}
...
resource "aws_instance" "kube-master" {
    ...
    key_name = "clarus"
    subnet_id = "subnet-0fd4f60741f25f2b8"  # select own subnet_id of us-east-1a
